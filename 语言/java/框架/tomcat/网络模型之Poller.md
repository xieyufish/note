...
控制读写的超时时间，默认为20000毫秒；判断超时的时候不会由这个值来严格决定，还与**timeoutInterval**这个值有关，这个值的默认时间为1秒，且不可变更，所以严格来说默认情况，如果一个连接在20秒的内没有发送过信息可能不会被关闭。

## 六、Poller工作流程图

![image-20200729231237628](images/image-20200729231237628.png)
